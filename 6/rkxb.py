...
def rkxbreaker(cipherfile):
	with open(cipherfile,'r') as f:
		...
		for keysize in range(2,41):
			...
			ndist23 = float(hamming.hamming(hextext[keysize*2:keysize*4],hextext[keysize*4:keysize*6]))/keysize
			ndist24 = float(hamming.hamming(hextext[keysize*2:keysize*4],hextext[keysize*6:keysize*8]))/keysize
			ndist34 = float(hamming.hamming(hextext[keysize*4:keysize*6],hextext[keysize*6:keysize*8]))/keysize
